...
function App() {
  ...
  const handleClick = () => {
    ...
    link.download = "Automate_Talentely.exe";
      ...
      <div className='listsNotes'>
        ...
        <ul>
          <li><p>
            ...
            Designed with students, professionals, and lifelong learners in mind, our platform is your one-stop destination for effortless and efficient test performance.</p>
          </li>

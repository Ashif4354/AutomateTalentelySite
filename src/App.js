  ...
  return (
    <div className='talently'>
      ...
      <div className='btnbtn'>
        ...
        <p className = 'note'>Note: This Version works as of 11-Aug-2023 if you follow the instructions given in <strong>_README.txt</strong> file present in the installation directory after you install the app.</p>      
      </div>
      <footer>
